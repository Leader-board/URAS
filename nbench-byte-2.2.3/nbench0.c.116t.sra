...
main (int argc, char * * argv)
{
  ...
  output_string ("--------------------:------------------:-------------:------------\n");
  i_113 = testnum;
  testnum.16_321 = testnum;
  if (i_113 <= testnum.16_321)
    goto <bb 9>; [85.00%]
  else
    goto <bb 58>; [15.00%]

  <bb 9> [51.51%]:
  # i_320 = PHI <i_146(57), i_113(8)>
  # lx_memindex_319 = PHI <lx_memindex_44(57), 1.0e+0(8)>
  # lx_intindex_317 = PHI <lx_intindex_47(57), 1.0e+0(8)>
  # lx_fpindex_315 = PHI <lx_fpindex_50(57), 1.0e+0(8)>
  # intindex_313 = PHI <intindex_53(57), 1.0e+0(8)>
  # fpindex_322 = PHI <fpindex_56(57), 1.0e+0(8)>
  ...
  <bb 20> [17.00%]:
  # lx_memindex_43 = PHI <lx_memindex_319(15), lx_memindex_319(18), lx_memindex_137(19)>
  # lx_intindex_46 = PHI <lx_intindex_317(15), lx_intindex_138(18), lx_intindex_317(19)>
  # lx_fpindex_49 = PHI <lx_fpindex_140(15), lx_fpindex_315(18), lx_fpindex_315(19)>
  # intindex_52 = PHI <intindex_313(15), intindex_136(18), intindex_136(19)>
  # fpindex_55 = PHI <fpindex_139(15), fpindex_322(18), fpindex_322(19)>
...
<L39> [5.61%]:
  ...
  <bb 57> [51.51%]:
  # lx_memindex_44 = PHI <lx_memindex_319(9), lx_memindex_43(20), lx_memindex_43(56)>
  # lx_intindex_47 = PHI <lx_intindex_317(9), lx_intindex_46(20), lx_intindex_46(56)>
  # lx_fpindex_50 = PHI <lx_fpindex_315(9), lx_fpindex_49(20), lx_fpindex_49(56)>
  # intindex_53 = PHI <intindex_313(9), intindex_52(20), intindex_52(56)>
  # fpindex_56 = PHI <fpindex_322(9), fpindex_55(20), fpindex_55(56)>
  i_146 = i_320 + 1;
  testnum.16_32 = testnum;
  if (testnum.16_32 >= i_146)
    goto <bb 9>; [85.00%]
  else
    goto <bb 58>; [15.00%]

  <bb 58> [9.09%]:
  # lx_memindex_318 = PHI <lx_memindex_44(57), 1.0e+0(8)>
  # lx_intindex_316 = PHI <lx_intindex_47(57), 1.0e+0(8)>
  # lx_fpindex_314 = PHI <lx_fpindex_50(57), 1.0e+0(8)>
  # intindex_312 = PHI <intindex_53(57), 1.0e+0(8)>
  # fpindex_311 = PHI <fpindex_56(57), 1.0e+0(8)>
  ...
  _34 = pow (intindex_312, 1.428570000000000117523768494720570743083953857421875e-1);
  __builtin___sprintf_chk (&buffer, 1, 1024, "INTEGER INDEX       : %.3f\n", _34);
  output_string (&buffer);
  _35 = pow (fpindex_311, 3.3333000000000001517008740847813896834850311279296875e-1);
  ...
  output_string (&buffer);
  _39 = pow (lx_intindex_316, 2.5e-1);
  __builtin___sprintf_chk (&buffer, 1, 1024, "INTEGER INDEX       : %.3f\n", _39);
  output_string (&buffer);
  _40 = pow (lx_fpindex_314, 3.33333333299999978738270556277711875736713409423828125e-1);
  __builtin___sprintf_chk (&buffer, 1, 1024, "FLOATING-POINT INDEX: %.3f\n", _40);
  output_string (&buffer);
